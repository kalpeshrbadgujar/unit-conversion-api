...
public static class UnitCatalog
{
    ...
    [
        ...
        new() { Code = "inch", Name = "Inch", Category = ConversionCategory.Length },
        new() { Code = "yard", Name = "Yard", Category = ConversionCategory.Length },
        new() { Code = "mile", Name = "Mile", Category = ConversionCategory.Length },
        new() { Code = "millimeter", Name = "Millimeter", Category = ConversionCategory.Length },
        new() { Code = "centimeter", Name = "Centimeter", Category = ConversionCategory.Length },
        ...
        new() { Code = "tonne", Name = "Tonne", Category = ConversionCategory.Weight },
        new() { Code = "gram", Name = "Gram", Category = ConversionCategory.Weight },
        new() { Code = "ounce", Name = "Ounce", Category = ConversionCategory.Weight },
